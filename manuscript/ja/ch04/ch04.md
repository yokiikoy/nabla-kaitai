...
**⑥ 一般の変換で定義する。** より一般に、$3$-form $\Omega = \rho(x,y,z)\,dx \wedge dy \wedge dz$ と、空間の変換 $\Phi(u,v,w) = (x(u,v,w), y(u,v,w), z(u,v,w))$ に対して、標準の引き戻し $\Phi^*$ は三個の方向すべての偏微分を求め、その $3 \times 3$ 行列式をとる：
