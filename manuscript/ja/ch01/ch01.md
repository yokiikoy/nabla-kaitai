...
次章では、この三つを組み合わせて<strong>面積測定器・体積測定器（</strong>$2$<strong>-form, </strong>$3$<strong>-form）</strong>を作る<strong>ウェッジ積（外積 </strong>$\wedge$<strong>）</strong>を導入し、ベクトルに作用してスカラーを返す型にとどまらない<strong>高次の微分形式</strong>へと進む。曲線・曲面・領域に沿った集計（線積分・面積分・体積分）は、それらの測定器を揃えた後の章で扱う。
<!-- role: roadmap -->
