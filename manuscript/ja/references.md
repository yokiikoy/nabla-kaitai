...
【コメント：本書の先にある一つの展望——計量と幾何の統合】本書を終えた読者が次に向かうべき、現代物理学の最前線（幾何代数）。本書では Burke の哲学に倣い「計量」と「幾何」を徹底的に分離（ $d$ と $\ast$ ）したが、幾何代数では「幾何積」として最初からそれらが不可分に統合されている。分離の苦しみを知った読者こそが、この統合のパラダイムの面白さを理解できるはずだ。
