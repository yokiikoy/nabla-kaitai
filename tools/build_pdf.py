...
try:
    ...
    preamble = (
        ...
        r'\pagestyle{fancy}' '\n'
        r'\fancyhf{}' '\n'
        r'\fancyfoot[L]{\tiny \textcopyright\ yokiikoy (CC BY-NC 4.0). 本書の最新版・PDF・正誤表・改訂履歴・関連情報・本書以外のコンテンツはポータルサイト \href{https://covectorspace.xyz/jp/}{Project Co-Vector Space} をご確認ください。}' '\n'
        r'\fancyfoot[C]{\thepage}' '\n'
        r'\fancypagestyle{plain}{\fancyhf{}\fancyfoot[L]{\tiny \textcopyright\ yokiikoy (CC BY-NC 4.0). 本書の最新版・PDF・正誤表・改訂履歴・関連情報・本書以外のコンテンツはポータルサイト \href{https://covectorspace.xyz/jp/}{Project Co-Vector Space} をご確認ください。}\fancyfoot[C]{\thepage}\renewcommand{\headrulewidth}{0pt}}' '\n'
